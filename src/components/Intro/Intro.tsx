...
const Intro = () => (
  <div className="main">
    ...
    <section className="main-text">
      ...
      <p className="main-paragraph">I am a Software Engineer focused on building aesthetically pleasing products. You can check out my <a href="/resume">resume</a> 👈 there. You can also find me on these social mediums: <a href="https://github.com/damdeez">Github</a>, <a href="https://twitter.com/damdeez">Twitter</a>, <a href="https://www.linkedin.com/in/damirharambasic">LinkedIn</a>, or feel free to send me a good ol&apos; <a href="mailto:damir.hara@gmail.com">email</a>. ☕️
      </p>
    </section>
  </div>
);
