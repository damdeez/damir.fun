...
const Intro = () => (
  <div className="main">
    ...
    <section className="main-text">
      <h1 className="intro-paragraph">
        <span aria-hidden="true">&gt;</span>{" "}Hi, my name is Damir.
      </h1>
      <p className="main-paragraph">
        ...
        <a href="https://github.com/damdeez" rel="noopener noreferrer">Github</a>,{" "}
        <a href="https://www.linkedin.com/in/damirharambasic" rel="noopener noreferrer">LinkedIn</a>, or
